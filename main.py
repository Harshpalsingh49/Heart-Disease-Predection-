...
st.set_page_config(page_title="Heart  Predictor",page_icon="⚕️",layout="centered",initial_sidebar_state="expanded")
...
html_temp = """ 
    ...
    <h1 style ="color:White;text-align:center;">Heart Disease Predictor</h1> 
    </div> 
    """
